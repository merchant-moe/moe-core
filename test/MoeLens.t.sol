...
contract MoeLensTest is Test {
    ...
    function test_GetReserves() public {
        ...
        assertEq(farms.farms[0].reserves.binStep, 0, "test_GetReserves::9");
        assertEq(farms.farms[0].reserves.baseFee, 0.003e18, "test_GetReserves::10");
        assertEq(farms.farms[0].reserves.variableFee, 0, "test_GetReserves::11");
        ...
        assertEq(farms.farms[1].reserves.binStep, 1, "test_GetReserves::19");
        assertEq(farms.farms[1].reserves.baseFee, 0.0002e18, "test_GetReserves::20");
        assertEq(farms.farms[1].reserves.variableFee, 0, "test_GetReserves::21");
        ...
        assertEq(farms.farms[2].reserves.binStep, 15, "test_GetReserves::29");
        assertEq(farms.farms[2].reserves.baseFee, 0.0015e18, "test_GetReserves::30");
        assertEq(farms.farms[2].reserves.variableFee, 0, "test_GetReserves::31");
        assertEq(farms.farms[2].reserves.protocolShare, 0.1e18, "test_GetReserves::32");
        assertEq(farms.farms[2].lpToken.symbol, "Vote LB WAVAX-USDC:15", "test_GetReserves::33");
        ...
        assertEq(farms.staticShare, 0.5e18, "test_GetReserves::34");
        ...
        assertEq(farms.farms[0].reserves.binStep, 0, "test_GetReserves::42");
        assertEq(farms.farms[0].reserves.baseFee, 0.003e18, "test_GetReserves::43");
        assertEq(farms.farms[0].reserves.variableFee, 0, "test_GetReserves::44");
        ...
        assertEq(farms.farms[1].reserves.binStep, 1, "test_GetReserves::52");
        assertEq(farms.farms[1].reserves.baseFee, 0.0002e18, "test_GetReserves::53");
        assertEq(farms.farms[1].reserves.variableFee, 0, "test_GetReserves::54");
        ...
        assertEq(farms.farms[2].reserves.binStep, 15, "test_GetReserves::62");
        assertEq(farms.farms[2].reserves.baseFee, 0.0015e18, "test_GetReserves::63");
